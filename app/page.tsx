    ...
    <main>
      ...
      <section className="reviews section" id="ulasan">
        ...
        <div className="testimonial-grid">
          ...
          <article className="testimonial testimonial-more"><div className="testimonial-more-inner"><div className="testimonial-more-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p className="testimonial-more-count">1.300+</p><p className="testimonial-more-label">Dipercaya 1.300+ peserta &middot; Rated 5&#9733; di Google</p></div></article>
        </div>
